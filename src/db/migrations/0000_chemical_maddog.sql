...
ALTER TABLE "vendor_reports" ADD CONSTRAINT "vendor_reports_vendor_id_vendors_id_fk" FOREIGN KEY ("vendor_id") REFERENCES "public"."vendors"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_branches_area" ON "branches" USING btree ("area");--> statement-breakpoint
...
CREATE INDEX "idx_vendor_reports_vendor" ON "vendor_reports" USING btree ("vendor_id");--> statement-breakpoint
